...
def _summary_row(row: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "projection_threshold_mode": row.get("projection_threshold_mode"),
        ...
        "words_per_program": row.get("words_per_program"),
...
def _sort_key(row: Dict[str, Any]) -> Tuple[Any, ...]:
    return (
        ...
        str(row.get("projection_threshold_mode")),
        ...
        print(
            " ".join(
                [
                    ...
                    f"{_fmt(row.get('projection_threshold_mode')):>10}",
                    f"{_fmt(row.get('filter_margin')):>10}",
                    f"{_fmt(row.get('scan_region')):>10}",
                    f"{_fmt(row.get('words_per_program')):>10}",
