"""Modal runner for StreamAttn decode wrapper profiling."""
...
app = modal.App("streamattn-decode-wrapper")
...
def _profile(
    *,
    ...
    cmd = [
        "python",
        "/root/StreamAttn/benchmarks/profile_stream_attn_decode_wrapper.py",
        "--decode-cost-json",
        cost_path,
        "--query-lens",
        query_lens,
